...
def run_task(run_cross_val = True, clf_optimal_idx = 0, use_grayscale = True, show_mean = False, gen_convergence_plot = False, plot_conv_path = "", plot_conf_path = ""):
    ...
    if gen_convergence_plot:
        ...
        plot_convergence(clf_optimal, X_train, y_train, plot_conv_path)
